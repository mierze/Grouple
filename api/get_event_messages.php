<?php
	...
	$id = $_POST['id'];
	$stmt = $mysqli->prepare("SELECT em.message, em.sender, em.send_date, u.first, u.last FROM e_messages em join users u WHERE e_id = ? and em.sender = u.email ORDER BY `send_date` ASC");
