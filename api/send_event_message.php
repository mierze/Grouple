<?php
	...
	if(!isset($_POST['msg']) || !isset($_POST['sender']) || !isset($_POST['e_id']))
	{
		$result["success"] = -99;
		$result["message"] = "Missing required POST parameters (msg, sender, e_id)";
	...
	$stmt->bind_param('sss', $msg, $sender, $e_id);
