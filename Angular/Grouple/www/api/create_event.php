<?php
	...
	|| !isset($_POST['maxPart']) || !isset($_POST['creator']) || !isset($_POST['recurring']) || !isset($_POST['pub']))
	{
		$response["success"] = -99;
		$response["message"] = "Missing required POST parameters (name, startDate, endDate, category, about, location, minPart, maxPart, creator, recurring, pub)";
