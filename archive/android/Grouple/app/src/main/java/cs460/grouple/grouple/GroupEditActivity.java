 ...
 * GroupEditActivity allows user to make changes to the information of a Group.
 */
public class GroupEditActivity extends BaseActivity
{
		...
		confirmDeleteButton.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View view)
			{
				if (confirmEditText.getText().toString().equals("Yes"))
				{
					...
					new deleteGroupTask().execute("http://mierze.gear.host/grouple/android_connect/delete_group.php");
				}
	...
	public void submitButton(View view)
	{
		...
		{
			new setProfileTask()
					.execute("http://mierze.gear.host/grouple/android_connect/update_group.php");
		}
	}
