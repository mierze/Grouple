...
{ 
	...
	public void onClick(View view)
	{
		...
		case R.id.declineButton:
			if (CONTENT.equals(CONTENT_TYPE.GROUP_INVITES.toString()))
			{
				new performActionTask().execute("http://mierze.gear.host/grouple/android_connect/leave_group.php",
						user.getEmail(), id);
			}
			break;
		case R.id.acceptButton:
			if (CONTENT.equals(CONTENT_TYPE.GROUP_INVITES.toString()))
			{
				new performActionTask().execute("http://mierze.gear.host/grouple/android_connect/accept_group_invite.php",
						user.getEmail(), id);
			}
			break;
		}
