...
public class MessagesActivity extends BaseActivity
{
	...
	{
		new readMessagesTask().execute("http://mierze.gear.host/grouple/android_connect/update_messageread_date.php");
	}
	...
	public void onClick(final View view)
	{
		...
		if (view == findViewById(R.id.sendButton))
		{
			...
			if (!(message.compareTo("") == 0))
			{
				...
				new storeMessageTask().execute("http://mierze.gear.host/grouple/android_connect/send_message.php", message,
