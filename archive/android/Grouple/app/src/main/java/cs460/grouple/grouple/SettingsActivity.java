...
public class SettingsActivity extends BaseActivity
{
	...
	public void onPause() {
	    ...
	    new UpdateSettingsTask().execute("http://mierze.gear.host/grouple/"
	...
	public void ConfirmEmailChangeButton(View view)
	{
		...
		{
		    new ChangeEmailTask().execute("http://mierze.gear.host/grouple/"
							...
							new DialogInterface.OnClickListener()
							{
										...
										DialogInterface dialog, int id)
								{
									//attempt to delete Account
									  new DeleteAccountTask().execute("http://mierze.gear.host/grouple/"
