...
public class EventEditActivity extends BaseActivity
{
	...
	public void submitButton(View view)
	{
		...
		else
		{
				...
				new AlertDialog.Builder(this).setMessage("Are you sure you want to repropose this event?")
						.setCancelable(true).setPositiveButton("Yes", new DialogInterface.OnClickListener()
						{
							...
							public void onClick(DialogInterface dialog, int id)
							{
								...
								new SetProfileTask().execute("http://mierze.gear.host/grouple/"
			...
			{
				new SetProfileTask().execute("http://mierze.gear.host/grouple/" + "android_connect/update_event.php");
			}
	...
	private void updateItemChecklist()
	{
		for (EventItem item : items)
		{
			...
			new updateItemChecklistTask().execute("http://mierze.gear.host/grouple/android_connect/update_item_checklist.php", id,
	...
	public void deleteEvent(View view)
	{
		...
		confirmDeleteButton.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View view)
			{
				...
				{
					new deleteEventTask().execute("http://mierze.gear.host/grouple/android_connect/delete_event.php");
				}
