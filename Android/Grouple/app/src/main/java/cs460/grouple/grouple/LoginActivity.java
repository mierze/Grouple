...
public class LoginActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(token !=null && email != null)
		{
			...
			new getLoginTask()
			.execute("http://mierze.gear.host/grouple/android_connect/get_login.php?email="
					+ email + "&token=" + token);
		}
		else
		{
	...
	public void RequestResetCodeButton(View view)
	{
		...
		else
		{
			...
			new RequestResetCodeTask().execute("http://mierze.gear.host/grouple/"
	...
	public void ConfirmResetCodeButton(View view)
	{
		...
		else
		{
			...
			new ConfirmResetCodeTask().execute("http://mierze.gear.host/grouple/"
	...
	public void ConfirmPasswordChangeButton(View view)
	{
		...
		{
		    new ChangePasswordTask().execute("http://mierze.gear.host/grouple/"
