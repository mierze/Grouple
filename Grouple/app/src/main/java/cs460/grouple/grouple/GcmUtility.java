...
public class GcmUtility extends Application {
	...
	public void sendNotification(String recipient, String notificationType) 
	{
		...
		new getRegIDTask().execute("http://mierze.gear.host/grouple/android_connect/get_chat_id.php", recipient);
	}
	/*
	...
	{
			new getMultipleRegIDsTask().execute("http://mierze.gear.host/grouple/android_connect/get_chat_id.php", multipleEmailList.get(multipleEmailList.size()-1));
	}
	...
	public void getRegIdByGid(ArrayList<Integer> g_ids)
	{
		...
		new getRegIdsByGidTask().execute("http://mierze.gear.host/grouple/android_connect/get_reg_ids_by_g_id.php",g_id_list.get(g_id_list.size()-1).toString());
	}
	...
	public void sendEventUpdated(String eName, String e_id)
	{
		...
		eventName = eName;
		eventID = e_id;
		new getRegIdsByEidTask().execute("http://mierze.gear.host/grouple/android_connect/get_reg_ids_by_e_id.php", e_id);
	}
