...
public class GroupDataService extends Service
{
	...
	public void fetchContent(String fetch, Context context)
	{
		...
		if (fetch.equals(FETCH_TYPE.INFO.toString()))
			new getInfoTask().execute("http://mierze.gear.host/grouple/android_connect/get_group_info.php",
			...
			new getMembersTask().execute("http://mierze.gear.host/grouple/android_connect/get_group_members.php?gid="
					+ group.getID());
		else if (fetch.equals(FETCH_TYPE.EXPERIENCE.toString()))
			new getExperienceTask().execute("http://mierze.gear.host/grouple/android_connect/get_group_experience.php");
		else if (fetch.equals(FETCH_TYPE.EVENTS.toString()))
			new getEventsTask().execute("http://mierze.gear.host/grouple/android_connect/get_group_events.php");
